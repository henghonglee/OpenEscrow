...
contract TestContract is Test {
    ...
    function hexStringToBytes(
        ...
        for (uint256 i = 0; i < length; i++) {
            byteArray[i] = bytes1(
                uint8(hexCharToUint(hexString, i * 2)) *
                    16 +
                    uint8(hexCharToUint(hexString, i * 2 + 1))
            );
        }
    ...
    function testSwap() public {
        console.logBytes32(_paymentHash); // 69d6788dea734d195656858726cec13c85ab0b8ea40d30ff816be135bc9f6f94
